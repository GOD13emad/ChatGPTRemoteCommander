...
const patterns = [
  ...
  // The product's canonical secret prefix is lowercase. Keep this check
  // case-sensitive so fail-closed error symbols such as
  // TUNNEL_HEALTH_UNKNOWN_LISTENER are not mistaken for credentials.

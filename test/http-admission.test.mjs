...
test('real candidate HTTP dispatcher blocks browser origins and keeps local JSON RPC', async () => {
  ...
  try {
    ...
    for(const f of ['server-v0.3.mjs','transport-guard.mjs','gui-tools-windows.mjs','gui-contract.mjs','gui-process.mjs']) await fs.copyFile(new URL('../src/'+f,import.meta.url),path.join(root,'src',f));

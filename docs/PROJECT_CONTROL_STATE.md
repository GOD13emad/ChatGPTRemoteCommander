...
- [v0.9.1](RELEASE_0.9.1.md) is the current release-hardening candidate. It preserves the v0.9.0 Full Power Project Engine parity and closes exact-tag acceptance defects found only under fresh/repeated installer qualification: Linux skip/reuse tunnel-client parity and a Windows test-only browser shutdown rejection race.
...
CURRENT: v0.9.1 release hardening and final qualification.
...
- Validation: [v0.9.1 candidate](RELEASE_0.9.1.md), [v0.8.42 published baseline](RELEASE_0.8.42.md), [v0.8.40 historical candidate](RELEASE_0.8.40.md), [v0.8.39 historical candidate](RELEASE_0.8.39.md), [qualification history](PROJECT_ENGINE_VALIDATION.md), [GUI acceptance](GUI_ACCEPTANCE.md).

...
## Current release work — v0.8.32 candidate

- 2026-09-23: User explicitly authorized Windows/Linux finalization and GitHub publication. Milestone 4A is implemented and pushed in PR #5; exact candidate gates are tracked in RELEASE_0.8.32.md.

...
- [v0.8.41](RELEASE_0.8.41.md) is the latest immutable **published GitHub Release**: public release present, 13 assets, hosted Windows/Ubuntu CI successful.
- [v0.9.0](RELEASE_0.9.0.md) is the current capability-parity candidate. It carries v0.8.41 retry/background hardening and adds Full Power Project Engine runner convergence across the two Emad deployments when the qualified local provider exists.
...
Open gates: focused parity regression, full Windows test/check/audit, independent Linux exact-commit test/check/audit, candidate-first installer/updater acceptance on both Emad devices, hosted CI, reproducible release bundle, immutable GitHub publication, then post-rollout runtime/tunnel verification. No v0.9.0 publication or deployment is claimed until these gates produce evidence.
...
- Validation: [v0.9.0 candidate](RELEASE_0.9.0.md), [v0.8.41 published baseline](RELEASE_0.8.41.md), [v0.8.40 historical candidate](RELEASE_0.8.40.md), [v0.8.39 historical candidate](RELEASE_0.8.39.md), [qualification history](PROJECT_ENGINE_VALIDATION.md), [GUI acceptance](GUI_ACCEPTANCE.md).

...
- [v0.8.37](RELEASE_0.8.37.md) remains the latest immutable public release.
- [v0.8.38](RELEASE_0.8.38.md) is a superseded unpublished candidate. Its tag predates the final browser hardening and is intentionally not moved. Two independent review rounds found ten pre-publication browser defects; all are being closed with dedicated regressions before a new-version release.
...
- Validation: [superseded v0.8.38 candidate](RELEASE_0.8.38.md), [qualification history](PROJECT_ENGINE_VALIDATION.md), [GUI acceptance](GUI_ACCEPTANCE.md).

...
| Second hardening focused gate | PASS — 16/16 focused browser/process regressions, descendant tree termination, persistent-profile preservation, Unicode/space path execution, headless relaunch recovery, native Chrome headless E2E |

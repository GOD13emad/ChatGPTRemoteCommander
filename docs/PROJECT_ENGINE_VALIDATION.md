...
Scope: development and release qualification history. Current candidate evidence is recorded in [v0.9.3](RELEASE_0.9.3.md); v0.9.1 and v0.9.0 are immutable published releases, while v0.9.2 is the unpublished installer-cleanup candidate carried into v0.9.3. The earlier live-compatibility baseline is [v0.8.42](RELEASE_0.8.42.md), carrying the v0.8.41 retry hardening; historical entries below retain their original dates, versions and limits.
